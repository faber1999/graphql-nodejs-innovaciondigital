...
const Mutation = {
    ...
    // updateUser: async (parents, { id, data }, { request, prisma }, info) => {
    ...
    // createAuthor: async (parents, { data }, { request, prisma, pubsub }, info) => {
    ...
    // updateAuthor: async (parents, { id, data }, { request, prisma, pubsub }, info) => {
